...
class CreatesControllerTest < ActionController::TestCase
  ...
  test "should create create" do
    assert_difference('Create.count') do
      post :create, create: { character: @create.character, droid: @create.droid, planet: @create.planet, quote: @create.quote, species: @create.species, vehicle: @create.vehicle }
    end
  ...
  test "should update create" do
    patch :update, id: @create, create: { character: @create.character, droid: @create.droid, planet: @create.planet, quote: @create.quote, species: @create.species, vehicle: @create.vehicle }
    assert_redirected_to create_path(assigns(:create))
  end
